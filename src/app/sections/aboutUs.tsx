  ...
  return (
    ...
    <section id="aboutus" className='relative flex flex-col pt-[6vw] ' > 
      ...
      <div className='justify-center items-center grid grid-cols-2 gap-[7.5vw] bg-[#48536B] p-25'>
        ...
        <Image
          src="/images/shake hands.jpeg"
                ...
                layout="relative"
                sizes="33vw"
                className="object-contain w-[90%] max-w-5xl h-auto rounded-xl"
                width = {600}
                height={300}
      ...
      <div className='grid grid-rows-2 align-middle justify-center'>
        <div className='grid grid-cols-[30.5%_0.5%_69%] align-middle justify-center text-black bg-[#7585A6] mx-auto w-[100vw] p-20 md:p-14 sm:p-8 items-center'>
          <h1 className='lg:text-5xl sm:text-3xl lg:pb-5 md:pb-3 sm:pb-1 font-raleway font-bold pl-10 text-center'> Mission </h1>
          <div className="w-1 bg-black opacity-70" style={{ height: '80%' }}></div>
          <p className='lg:text-[20px] md:text-[16px] sm:text-[10px] w-[50vw] font-lexendDeca mx-auto text-left font-medium'> {mission} </p>
        </div>
        <div className='grid grid-cols-[69%_1%_30%] align-middle justify-center text-black bg-[#899ABE] mx-auto w-[100vw] p-15 items-center'>
          <p className='lg:text-[20px] md:text-[16px] w-[50vw] font-lexendDeca mx-auto text-right'> {vision} </p>
          <hr className='bg-black opacity-70 size-1 h-[80%] items-center align-middle justify-center'></hr>
          <h1 className='text-5xl lg:pb-5 md:pb-3 sm:pb-1 font-raleway font-bold pl-10 text-center'> Vision </h1>
